...
def get_coexpression_network_from_train(adata, threshold, k, data_path,
    ...
    if os.path.exists(fname):
        ...
        X_tr = X[adata.obs.condition == 'ctrl']
...
def uncertainty_loss_fct(pred, logvar, y, perts, reg = 0.1, ctrl = None,
                         direction_lambda = 1e-3, dict_filter = None, gamma = 2):
    #gamma = 2                     
...
def loss_fct(pred, y, perts, ctrl = None, direction_lambda = 1e-3, dict_filter = None, gamma = 2):
    #gamma = 2
